public class PersonInfo5 {
    ...
    public static String firstName = "Jean-Pamphile";
    public static String lastName = "Goutondji";
    public static int studentNo = 300019368;
    public static String description = "Hello, my name is J-P";
